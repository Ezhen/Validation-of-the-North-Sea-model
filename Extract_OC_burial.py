...
yrange = [2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2011,2012,   2021,2022,2023]
...
m1 = Basemap(projection='merc',llcrnrlat=48.0,urcrnrlat=59.6,llcrnrlon=-3,urcrnrlon=10.8,lat_0=3,resolution='i', ax=ax)
x2, y2 = m1(lons, lats)
...
fig.savefig("./Figures/Carbon_sequestration_clima.png", dpi=300, bbox_inches='tight')
